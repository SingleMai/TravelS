...
### 用户更新学历证验证信息// TODO 暂时省略，与之前的接口合并
接口： `/api/users/eduCard`
类型： `PUT`
...
### 用户获取导游证验证信息// TODO 暂时省略，与之前的接口合并
...
### 用户更新导游证验证信息// TODO 暂时省略，与之前的接口合并
接口： `/api/users/guideCard`
类型： `PUT`
...
### 用户获取驾驶证验证信息// TODO 暂时省略，与之前的接口合并
...
### 用户更新驾驶证验证信息// TODO 暂时省略，与之前的接口合并
接口： `/api/users/driveCard`
类型： `PUT`
...
### 删除店铺// TODO 暂时不提供商店删除功能，以后考虑加入打烊功能
接口： `/api/shop`
类型： `DELETE`
...
### 删除服务（删除附带图片文件等）// TODO 删除富文本内的图片还需要进一步完善
接口： `/api/servie`
类型： `DELETE`
...
### 服务富文本创建照片 // TODO 这里的图片id在servies创建和更新的时候进行刷新
接口：`api/servies/img`
类型： `POST`
